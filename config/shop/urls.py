...
from config.shop.views.views import BannerViews,MainCategoriesDetailsView, ProductViews, ServiceViews, OurPartnerViews, ConsultantViews, ProductDetailView,CategoriesView, CategoryDetailsView, ProductCardCreateView
