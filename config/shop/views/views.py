...
from config.shop.serializer.serializer import (
    ProductSerializer,
    OurPartnerSerializer,
    ServiceSerializer,
    ConsultantSerializer, MainCategoriesSerializer,
    ProductCardCreateSerializer
)
from config.shop.services.pagination import StandardResultsSetPagination
from config.shop.services.paginator import PaginationMethod
